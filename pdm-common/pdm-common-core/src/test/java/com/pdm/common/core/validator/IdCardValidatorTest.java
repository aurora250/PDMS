...
class IdCardValidatorTest {
    ...
    void shouldExtractBirthDate() {
        assertEquals(LocalDate.of(1990, 3, 7),
                IdCardValidator.extractBirthDate(VALID_MALE_1990));
        assertEquals(LocalDate.of(1995, 12, 12),
                IdCardValidator.extractBirthDate(VALID_FEMALE_1995));
        assertEquals(LocalDate.of(1988, 7, 2),
                IdCardValidator.extractBirthDate(VALID_FEMALE_1988));
    }
    ...
    void shouldThrowOnInvalidForBirthDate() {
        assertThrows(IllegalArgumentException.class,
                () -> IdCardValidator.extractBirthDate("12345"));
    }
