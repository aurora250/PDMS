 ...
 *
 * <p>负责配置整个认证授权模块的安全策略，包括：
 *
 * <ul>
 *   <li>禁用 CSRF 保护（适用于无状态 API）
 *   <li>设置会话管理为无状态模式
 *   <li>配置 URL 级别的权限控制
 *   <li>注册 JWT 认证过滤器
 *   <li>提供密码编码器 Bean
...
public class SecurityConfig {
     ...
     *
     * <ol>
     *   <li>登录、注册、刷新令牌接口及 Swagger 文档接口对所有用户放开
     *   <li>用户管理相关接口需要"系统管理员"或"用户管理员"角色
     *   <li>权限组管理接口仅允许"系统管理员"角色访问
     *   <li>其余所有请求均需认证后访问
     * </ol>
     *
     ...
     *
     * <p>用于用户密码的加密存储和校验，BCrypt 是一种自包含盐值的强哈希算法。
     *
