 ...
 *
 * <p>
 * 提供流动人口管理相关的 REST API 接口，包括流动人口登记、居住证管理（申请、审批、签发、续期）、
 * 常住人口居住登记管理以及数据统计（热力图、趋势分析）。 所有接口挂载在 {@code /api/fp} 路径下，需携带有效 JWT 令牌方可访问。
 * </p>
 */
@RestController
...
public class FloatingPopulationController {
     ...
     *            居住证 ID
     * @param reviewerUuid
     *            审核人 UUID，从请求头 {@code X-User-Uuid} 中获取
     * @return 审批后的居住证实體
     */
     ...
     *
     * <p>
     * 审批通过后正式签发居住证，设置签发日期和有效期并关联到登记记录。
     * </p>
     *
     * @param id
     *            居住证 ID
