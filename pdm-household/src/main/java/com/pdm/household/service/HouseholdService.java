 ...
 * 户政业务服务接口。
 *
 * <p>提供户政管理相关的核心业务方法，包括：
 *
 * <ul>
 *   <li><b>户口本管理</b> —— 申请、补办、换新户口本。
 *   <li><b>业务审批</b> —— 提交和审批户政业务（登记、注销、户主变更等）。
 *   <li><b>迁移管理</b> —— 提交和审批户口迁移、查询迁移轨迹。
 *   <li><b>证件签发</b> —— 签发准迁证和迁移证。
 *   <li><b>区域查询</b> —— 获取行政区划区域树和子区域。
 * </ul>
 */
public interface HouseholdService {
     ...
     * @return 更新后的业务申请实体
     */
    HouseholdBusinessRequest approveBusiness(
     ...
     * @return 更新后的迁移申请实体
     */
    HouseholdMigrationRequest approveMigration(
            Long rid, String status, String handlerUuid, String rejectReason);
