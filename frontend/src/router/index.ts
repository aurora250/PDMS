  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'resident/:uuid', name: 'ResidentDetail', component: () => import('@/views/resident/ResidentDetail.vue') },
        ...
        { path: 'keyperson/gis', name: 'KeyPersonGis', component: () => import('@/views/keyperson/KeyPersonGis.vue') },
